...
do 
	...
	OUT="$ID"_recal2_data.table
	echo "$KNOWN"
	../java/jdk1.8.0_144/bin/java -jar ../GATK-3.8-0/GenomeAnalysisTK.jar -T BaseRecalibrator -R ../pp1137_chromosomes3.04.fasta -I $BAM -knownSites $KNOWN -o $OUT
done
