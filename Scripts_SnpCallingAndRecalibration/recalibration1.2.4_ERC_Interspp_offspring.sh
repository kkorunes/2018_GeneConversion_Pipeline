#!/bin/bash
#SBATCH --mem=20GB
cd /datacommons/noor/klk37/new_SNPcalling_and_GCpipeline/Interspecies

#Create gVCFs (every position, even non-variant, included)

FILES=/datacommons/noor2/klk37/new_GCpipeline/BAMfiles/00H*realigned.bam
for BAM in $FILES
do 
	...
	echo 'cd /datacommons/noor/klk37/new_SNPcalling_and_GCpipeline/Interspecies' >> $SCRIPT
